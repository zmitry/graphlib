import {has,constant,isFunction,keys,filter,isEmpty,each,isUndefined,union,reduce,isObject,map}from'lodash';const DEFAULT_EDGE_NAME = "\x00";
...
function read(json) {
  ...
  return g;
}export{Graph,read as readJSON,writeOne as writeDot,write as writeJSON};